        ...
        <div class="card">
            ...
            <div class="card-header py-3">
                <div class="row">
                    ...
                    @if (\App\Helpers\RoleHelper::isAuthorized('createUsers'))
                        <div class="col-md-1">
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    @if (\App\Helpers\RoleHelper::isAuthorized('updateUsers'))
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        {{ $users->appends(request()->except('page'))->links('components.customPaginator') }}
