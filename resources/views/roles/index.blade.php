        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    @if (\App\Helpers\RoleHelper::isAuthorized('createRoles'))
                        <div class="col-md-1">
            ...
            <div class="card-body">
                        ...
                        @foreach ($roles as $role)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (\App\Helpers\RoleHelper::isAuthorized('updateRoles'))
                                        <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-warning"><i class="bi bi-pencil-fill"></i></a>
                                    @endif


                                    @if (\App\Helpers\RoleHelper::isAuthorized('deleteRoles'))
                ...
                {{ $roles->appends(request()->except('page'))->links('components.customPaginator') }}
            </div>
        </div>
    </section>
@endsection
